...
enum ShadowTokens {
    struct Style {
        ...
        static let brandGlow = Style(color: ColorTokens.brandWarmAmber.opacity(0.16), radius: 22, x: 0, y: 12)
        static let brandGlowPressed = Style(color: ColorTokens.brandWarmAmber.opacity(0.24), radius: 16, x: 0, y: 8)
